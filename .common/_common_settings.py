...
RESOURCES_AMAZONLISTING_STATUS_STR_SET = {
    ...
    RESOURCES_AMAZONLISTING_STATUS_INVALID_ASIN: 'invalid asin',
    RESOURCES_AMAZONLISTING_STATUS_ASIN_NOT_IN_VARIATION: 'asin not in variation',
    RESOURCES_AMAZONLISTING_STATUS_NO_PRICE_GIVEN: 'no price',
    RESOURCES_AMAZONLISTING_STATUS_OUT_OF_STOCK: 'out of stock',
    RESOURCES_AMAZONLISTING_STATUS_FAILED_PARSING_PAGE: 'parsing failed',
}
